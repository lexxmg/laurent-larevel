      ...
      <div class="main__content-container">
        ...
        <div class="outs-create-out__container">
          ...
          >
            ...
            <input type="hidden" name="outCount" value="2">
            ...
            <div class="outs-create-out-form__inner-input">
              <label for="virt_on" class="outs-create-out-form__label">Выход релле на включение</label>
            ...
            <div class="outs-create-out-form__inner-input">
              <label for="virt_off" class="outs-create-out-form__label">Выход релле на выключение</label>
              <select class="outs-create-out-form__select" name="virt_off" id="virt_off">
                <option class="outs-create-out-form__option" value="1">
                  Relle-1
                </option>
                <option class="outs-create-out-form__option" value="2">
