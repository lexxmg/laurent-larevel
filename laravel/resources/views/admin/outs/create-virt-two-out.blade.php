      ...
      <div class="main__content-container">
        ...
        <div class="outs-create-out__container">
          ...
          >
            ...
            <div class="outs-create-out-form__inner-input">
              <label for="virt_on" class="outs-create-out-form__label">Выход OUT на включение</label>
            ...
            <div class="outs-create-out-form__inner-input">
              <label for="virt_off" class="outs-create-out-form__label">Выход OUT на выключение</label>
